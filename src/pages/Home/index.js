  ...
  useEffect(() => {
    ...
    const unsubscribe = messaging().onMessage(async remoteMessage => {
      ...
      PushNotification.localNotification({
        ...
        channelId: 'giveget', // (required) channelId, if the channel doesn't exist, notification will not trigger.
        ...
        <View
          ...
          <View style={{
            ...
            <TouchableOpacity
              ...
              <Text style={{
                position: 'absolute', top: 0, right: 0, bottom: 0, backgroundColor: colors.white, width: 18,
                textAlign: 'center',
          ...
          <View style={{
            ...
            <Image source={require('../../assets/logo2.png')} style={{ width: 100, height: 50, resizeMode: 'contain' }} />
